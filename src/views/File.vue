  ...
  <div class="bodys">
        ...
        >
          ...
          <div v-for="fl in fileList" :key="fl.fiid">
            ...
            >
              ...
              <div
                @click="fileView(fl)"
                @contextmenu.prevent="openDoingCard($event, fl)"
              >
                ...
                <div v-else>
                  ...
                  >
                    ...
                    ></path>
                    <path
                      d="M752 320h128L624 64v128a128 128 0 0 0 128 128z"
                      fill="#BCF7EF"
                      p-id="1490"
                    ></path>
                    <path
    ...
    <div>
      ...
      >
        ...
        <el-form
          ...
          :element-loading-text="'上传中：' + uploadFileLoading.progress + '%'"
        >
    ...
    <div>
      ...
      >
        <!-- 文件信息修改表单 -->
        <el-form
          v-loading="updateFileLoading.loading"
          :element-loading-text="'上传中：' + updateFileLoading.progress + '%'"
        >
          <el-form-item label="附加信息：">
            <div class="fileInfoWrites">
              <div>
          ...
          <el-form-item label="选择文件：">
            <el-upload
              ...
              action=""
              :show-file-list="false"
              :before-upload="chooseUpdateFile"
              drag
            >
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">
